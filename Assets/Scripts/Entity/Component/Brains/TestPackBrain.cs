...
{
    [CreateAssetMenu(fileName = "New Test Pack Brain", menuName = "Components/Brains/Test Pack Brain")]
    public class TestPackBrain : Brain
    {
        ...
        private IEnumerator LeaderLoop()
        {
            ...
            GoTo(Destination);
            float angle = Vector2.SignedAngle(Vector2.up, Me.Movement.WalkVector);
                ...
                for (int i = 0; i < Pack.Count; i++)
                {
                    ...
                    else
                    {
                        ...
                        if (Vector2.Distance(Pack[i].Me.Position, pos) > 0.5f)
                            Pack[i].Me.Stats.Speed = Me.Stats.Speed * 1.5f;
                        else
                            Pack[i].Me.Stats.Speed = Me.Stats.Speed * 0.95f;
