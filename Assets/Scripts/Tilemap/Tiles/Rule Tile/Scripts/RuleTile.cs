...
namespace UnityEngine
{
	...
	public class RuleTile : TileBase
	{
        ...
        // Custom - gdn001 - 24/08/2018
        public enum RuleMatchingModes
        {
            Self = 0,
            Any = 1,
            AnyButSelf = 2,
        ...
        public RuleMatchingModes m_RuleMatchingMode = RuleMatchingModes.Self;
        // End custom
        ...
        // Modified - gdn001 - 24/08/2018
        public virtual bool RuleMatch(int neighbor, TileBase tile)
        {
            bool matches = false;

            switch(m_RuleMatchingMode)
            {
                case RuleMatchingModes.Self:
                    matches = tile == m_Self;
                    break;
                case RuleMatchingModes.Any:
                    matches = tile != null;
                    break;
                case RuleMatchingModes.AnyButSelf:
                    matches = tile != null && tile != m_Self;
                    break;
            }

            switch (neighbor)
            {
                case TilingRule.Neighbor.This: return matches;
                case TilingRule.Neighbor.NotThis: return !matches;
            }
            return true;
        }
