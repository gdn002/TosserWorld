...
{
    [CreateAssetMenu(fileName = "New Basic Physics", menuName = "Components/Basic/Physics")]
    public class BasicPhysics : BasicComponent
    {
        ...
        {
            BasicPhysics clone = CreateInstance<BasicPhysics>();
